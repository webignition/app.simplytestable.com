...
namespace Tests\AppBundle\Functional\Command\Cron;

use Cron\CronBundle\Entity\CronReport;
use AppBundle\Command\Cron\RunCommand;
...
use AppBundle\Model\Job\Configuration\Values as JobConfigurationValues;
use AppBundle\Model\Job\TaskConfiguration\Collection as TaskConfigurationCollection;
use AppBundle\Entity\Job\TaskConfiguration as TaskConfiguration;
