...
class Version20120716214726_create_Worker_Job_TaskType_Task extends BaseMigration
{
    public function up(Schema $schema)
    {
        $this->statements['mysql'] = array(
            ...
            "CREATE TABLE Job (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, website_id INT DEFAULT NULL, state_id INT DEFAULT NULL, INDEX IDX_C395A618A76ED395 (user_id), INDEX IDX_C395A61818F45C82 (website_id), INDEX IDX_C395A6185D83CC1 (state_id), PRIMARY KEY(id)) ENGINE = InnoDB",
            ...
            "CREATE TABLE Task (id INT AUTO_INCREMENT NOT NULL, job_id INT DEFAULT NULL, state_id INT DEFAULT NULL, worker_id INT DEFAULT NULL, url LONGTEXT NOT NULL, INDEX IDX_F24C741BBE04EA9 (job_id), INDEX IDX_F24C741B5D83CC1 (state_id), INDEX IDX_F24C741B6B20BA36 (worker_id), PRIMARY KEY(id)) ENGINE = InnoDB",
