...
class Version20120724153426_create_JobTaskTypes extends BaseMigration
{
    public function up(Schema $schema)
    {
        $this->statements['mysql'] = array(
            "CREATE TABLE JobTaskTypes (tasktype_id INT NOT NULL, job_id INT NOT NULL, INDEX IDX_6520FB147D6EFC3 (tasktype_id), INDEX IDX_6520FB14BE04EA9 (job_id), PRIMARY KEY(tasktype_id, job_id)) ENGINE = InnoDB",
        ...
        $this->statements['sqlite'] = array(
            "CREATE TABLE JobTaskTypes (
                ...
                job_id INT NOT NULL,
                PRIMARY KEY (tasktype_id, job_id),
