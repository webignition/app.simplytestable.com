 ...
 */
class Version20120724124825_add_TaskTypeClass_add_class_and_description_to_Task extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE TaskTypeClass (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_F92FE5F25E237E06 (name), PRIMARY KEY(id)) ENGINE = InnoDB");
