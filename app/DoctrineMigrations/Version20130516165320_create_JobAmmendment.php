 ...
 */
class Version20130516165320_create_JobAmmendment extends BaseMigration
{    
    ...
    {        
        $this->statements['mysql'] = array(
            "CREATE TABLE JobAmmendment (
                ...
                UNIQUE INDEX UNIQ_E1E6DB74BE04EA9 (job_id),
        ...
        $this->statements['sqlite'] = array(
            ...
            "CREATE UNIQUE INDEX UNIQ_E1E6DB74BE04EA9 ON JobAmmendment (job_id)",
