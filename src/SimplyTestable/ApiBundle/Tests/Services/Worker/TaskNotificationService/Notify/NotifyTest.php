...
namespace SimplyTestable\ApiBundle\Tests\Services\Worker\TaskNotificationService\Notify;

use SimplyTestable\ApiBundle\Entity\Worker;
use SimplyTestable\ApiBundle\Tests\Services\Worker\TaskNotificationService\ServiceTest;
