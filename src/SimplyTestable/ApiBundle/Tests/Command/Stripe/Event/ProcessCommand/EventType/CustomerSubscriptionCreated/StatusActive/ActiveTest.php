...
abstract class ActiveTest extends CustomerSubscriptionCreatedTest {
    ...
    public function testWebClientEventBody() {        
        $this->assertEquals(
                'event=customer.subscription.created&status='.$this->getSubscriptionStatus().'&has_card='.((int)$this->getHasCard()).'&current_period_start=1392757613&current_period_end=1395176813',
