...
class AmountGreaterThanZeroTest extends InvoicePaymentSucceededTest {   
    ...
    public function testWebClientEventBody() {        
        $this->assertEquals(
                'event=invoice.payment_succeeded&user=user%40example.com&plan_name=Agency&plan_amount=1900&invoice_total=2000&period_start=1379776581&period_end=1382368580',
