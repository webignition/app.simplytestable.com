...
class TrialingToCanceledTest extends ActionStatusTest {   
    ...
    protected function getExpectedWebClientEventBody() {
        return 'event=customer.subscription.updated&is_status_change=1&previous_subscription_status='.$this->getPreviousSubscriptionStatus().'&subscription_status=' . $this->getCurrentSubscriptionStatus() . '&trial_days_remaining=30';
    }     
