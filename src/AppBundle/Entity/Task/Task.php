...
class Task implements \JsonSerializable
{
     ...
     * @var Job
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Job\Job", inversedBy="tasks")
     ...
     * @var Worker
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Worker", inversedBy="tasks")
     */
    protected $worker;
     ...
     * @var TaskType
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Task\Type\Type")
     ...
     * @var TimePeriod
     *
     * @ORM\OneToOne(targetEntity="AppBundle\Entity\TimePeriod", cascade={"persist", "remove"})
     */
     ...
     * @var Output
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Task\Output", cascade={"persist"})
     */
    protected $output;
