...
use AppBundle\Model\Task\Type\Collection as TaskTypeCollection;
...
class Job
{
     ...
     *
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Task\Task", mappedBy="job")
     */
    private $tasks;
     ...
     * @var JobType
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Job\Type")
     ...
     * @var DoctrineCollection
     *
     * @ORM\ManyToMany(targetEntity="AppBundle\Entity\Task\Type\Type")
     ...
     * @var DoctrineCollection
     *
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Job\TaskTypeOptions", mappedBy="job")
     *
     */
     ...
     *
     * @ORM\OneToMany(
     *     targetEntity="AppBundle\Entity\Job\Ammendment",
     *     mappedBy="job",
     *     cascade={"persist"}
     * )
     */
